...
const generateIEPHTML = (params: DownloadIEPParams): string => {
  ...
  const scoreColor = complianceScore >= 90 ? "#16a34a" : complianceScore >= 70 ? "#ea580c" : "#dc2626"
...
<body>
  ...
  <div class="container">
    <div class="header">
      ...
      <div class="compliance-badge">${complianceScore}% ${state} Compliant</div>
...
<body>
  ...
  <div class="container">
    <div class="header">
      ...
      <div class="compliance-badge">${state} Compliance Analysis</div>
      <div class="generated-date">Generated by EASI IEP on ${today}</div>
    </div>
